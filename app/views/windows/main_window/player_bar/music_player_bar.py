...
class MusicPlayerBar(QWidget, Component):
    ...
    def translateUI(self) -> None:
        self._titleLabel.setPlaceHolder(self.translate("MUSIC_PLAYER.SONG_TITLE"))
        self._artistLabel.setPlaceHolder(self.translate("MUSIC_PLAYER.SONG_ARTIST"))
    ...
    def __notifySongNotFound(self) -> None:
        Dialogs.alert(self.translate("MUSIC_PLAYER.PLAYING_DELETED_SONG"))
