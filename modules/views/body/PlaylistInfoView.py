...
class PlaylistInfoView(QVBoxLayout, ViewComponent):
    ...
    label_total_song: LabelWithDefaultText
    ...
    def setup_ui(self):
        ...
        self.label_total_song = LabelWithDefaultText.build(
            width=128,
        ...
        self.text_area.addWidget(self.label_title)
        self.text_area.addWidget(self.label_total_song)
    ...
    def set_cover(self, cover: bytes) -> None:
        self.cover.setPixmap(self.__get_cover_pixmap(cover))

    def set_default_cover(self, cover: bytes) -> None:
        self.cover.set_default_pixmap(self.__get_cover_pixmap(cover))
