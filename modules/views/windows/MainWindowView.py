...
class MainWindowView(FramelessWindow):
    ...
    def setup_ui(self) -> None:
        ...
        self.close_btn = IconButton.render(
            ...
            light_mode_background=Backgrounds.ROUNDED_HIDDEN_DANGER_50.with_border_radius(8),
            dark_mode_background=Backgrounds.ROUNDED_HIDDEN_DANGER_75.with_border_radius(8),
        )
